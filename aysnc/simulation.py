...
async def sim(conf, vars, iterations, random_first_server = False):
    logger.info('================================')
...
async def sim_match(conf, vars, random_first_server = False):
    # time.sleep(DELAY)
...
if __name__ == "__main__":
    ...
    ### Run the sim
    results = asyncio.run(sim(sim_config, sim_vars, sim_iterations, sim_random_first_server))

    ### Format the output and return / print
